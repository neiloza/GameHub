...
*Every move touches the mana economy. Amplify is how a character reaches the
...
*Set Prophecy, force them to rotate, and their fresh character walks into it.*

1. **Mindspike** — Standard damage. No cost.
2. **Mindshatter** — Heavy damage. High mana.
