...
const LIBERTY_REPOSITORY = {
  ...
  states: {
    ...
    NY: {
      ...
      bills: [
        {
          id: "state-ny-fair-news-act",
          level: "state",
          scope: "state",
          number: "S.8451-B / A.8962-B",
          title: "NY FAIR News Act",
          tagline: "Would require disclaimers on AI-generated news content.",
          summary:
            "The New York Fundamental Artificial Intelligence Requirements in News Act. Passed both the Senate and Assembly before the legislature adjourned in June 2026; requires news organizations operating in the state to include clear disclaimers on content substantially or wholly generated by AI.",
          topics: ["Technology", "Media"],
          status: "Passed Legislature",
          stage: "Passed both houses; awaiting the Governor's signature",
          sponsor: "Sen. Patricia Fahy",
          sourceUrl: "https://www.nysenate.gov/newsroom/press-releases/2026/patricia-fahy/new-york-legislature-passes-landmark-bill-disclose-ai",
        },
        {
          id: "state-ny-ai-training-data-act",
          level: "state",
          scope: "state",
          number: "AI Training Data Transparency Act",
          title: "AI Training Data Transparency Act",
          tagline: "Would require disclosure of data used to train large AI models.",
          summary:
            "Passed both chambers of the New York Legislature in 2026; enacts transparency requirements for the data used to train large language and generative AI models operating in New York.",
          topics: ["Technology"],
          status: "Passed Legislature",
          stage: "Passed both houses; awaiting the Governor's signature",
          sponsor: "New York State Legislature",
          sourceUrl: "https://www.transparencycoalition.ai/news/new-york-lawmakers-pass-kids-ai-chatbot-safety-bill-and-two-transparency-acts",
        },
      ],
      reps: [
        { id: "rep-ny-sen-schumer", role: "U.S. Senator", name: "Sen. Chuck Schumer", party: "D", website: "https://www.schumer.senate.gov/" },
        { id: "rep-ny-sen-gillibrand", role: "U.S. Senator", name: "Sen. Kirsten Gillibrand", party: "D", website: "https://www.gillibrand.senate.gov/" },
        { id: "rep-ny-gov", role: "Governor", name: "Gov. Kathy Hochul", party: "D", note: "Running for reelection in 2026.", website: "https://www.governor.ny.gov/" },
      ],
      events: [],
      candidates: [],
    },
    ...
    TX: {
      ...
      bills: [],
      reps: [
        { id: "rep-tx-sen-cornyn", role: "U.S. Senator", name: "Sen. John Cornyn", party: "R", note: "Lost the May 2026 GOP primary runoff for reelection to Ken Paxton; remains in office until a successor is seated in Jan 2027.", website: "https://www.cornyn.senate.gov/" },
        { id: "rep-tx-sen-cruz", role: "U.S. Senator", name: "Sen. Ted Cruz", party: "R", website: "https://www.cruz.senate.gov/" },
        { id: "rep-tx-gov", role: "Governor", name: "Gov. Greg Abbott", party: "R", note: "Seeking a fourth term in the Nov 3, 2026 election.", website: "https://gov.texas.gov/" },
      ],
      events: [],
      candidates: [
        {
          id: "candidate-tx-governor-2026",
          type: "candidate",
          race: "Texas Governor",
          tagline: "Abbott seeks a fourth term against Hinojosa.",
          description:
            "Incumbent Gov. Greg Abbott (R) faces State Rep. Gina Hinojosa (D), who won the Democratic primary, in the November 3, 2026 general election.",
          date: "General election: Nov 3, 2026",
          candidates: ["Greg Abbott (R)", "Gina Hinojosa (D)"],
          sourceUrl: "https://ballotpedia.org/Texas_gubernatorial_election,_2026",
        },
        {
          id: "candidate-tx-senate-2026",
          type: "candidate",
          race: "U.S. Senate, Texas",
          tagline: "Open-seat race after Paxton beat incumbent Cornyn in the GOP primary.",
          description:
            "State Attorney General Ken Paxton (R) defeated incumbent Sen. John Cornyn in the May 2026 GOP primary runoff and faces State Rep. James Talarico (D) in the November 3, 2026 general election.",
          date: "General election: Nov 3, 2026",
          candidates: ["Ken Paxton (R)", "James Talarico (D)"],
          sourceUrl: "https://ballotpedia.org/United_States_Senate_election_in_Texas,_2026",
        },
      ],
    },
  },
  ...
  locals: {
    ...
    "TX:austin": {
      ...
      bills: [
        {
          id: "local-austin-gas-franchise",
          level: "local",
          scope: "town",
          number: "Council Ordinance (3rd Reading)",
          title: "Texas Gas Service Franchise Agreement",
          tagline: "A 10-year franchise letting Texas Gas Service use city rights-of-way.",
          summary:
            "Grants Texas Gas Service Company a non-exclusive, 10-year franchise to use public rights-of-way and easements to provide natural gas distribution service, repealing the prior 2006 franchise ordinance. Approved on third reading July 23, 2026.",
          topics: ["Energy", "Government"],
          status: "Passed",
          stage: "Approved on third reading by Austin City Council, July 23, 2026",
          sponsor: "Austin City Council",
          sourceUrl: "https://www.austintexas.gov/council/2026/20260723-reg",
        },
      ],
      reps: [
        { id: "rep-austin-mayor", role: "Mayor", name: "Mayor Kirk Watson", website: "https://www.austintexas.gov/department/mayor" },
      ],
      events: [
        {
          id: "event-travis-county-commissioners",
          type: "event",
          title: "Travis County Commissioners Court — weekly sessions",
          tagline: "Weekly public voting sessions on county business.",
          description:
            "The Travis County Commissioners Court holds regular public voting sessions covering county budget, infrastructure, and appointments; agendas and minutes are posted in advance.",
          date: "Weekly",
          location: "Travis County, TX",
          sourceUrl: "https://www.traviscountytx.gov/commissioners-court",
        },
      ],
      candidates: [],
    },
